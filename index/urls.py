...
urlpatterns = [
    ...
    path('edit_post/<int:post_id>/', home_views.edit_post),
    path('delete_post/<int:post_id>/', home_views.delete_post),
    path('edit_comment/<int:comment_id>/', home_views.edit_comment),
    path('delete_comment/<int:comment_id>/', home_views.delete_comment),
